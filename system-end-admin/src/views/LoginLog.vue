    ...
    <div>
        <el-card>
            ...
            <el-table :data="list" stripe border>
                ...
                <el-table-column prop="email" label="用户邮箱" resizable />
                ...
                <el-table-column label="操作" width="80" resizable>
                    <template #default="{ row }">
                        <el-tooltip :content="row.device_info" placement="top" :disabled="!row.device_info">
...
const loadList = async () => {
    const res = await get('/user/loginLogs', query.value)
